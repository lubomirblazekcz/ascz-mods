class CfgPatches
{
	class ascz_thirsk_fix_thirsk_w
	{
		units[] = {"ThirskW"};
		worlds[] = {"ThirskW"};
		weapons[] = {};
		requiredVersion = 1.0;
		requiredAddons[] = {"ThirskW", "AiA_Worlds"};
		author[] = {"EvroMalarkey"};
		version = "1.0";
	};
};
...
class CfgWorlds
{
	...
	class ThirskW: Utes
	{
		...
		pictureMap = "\ascz_thirsk_fix\ThirskW\Data\Thirsk_w_ca.paa";
		pictureShot = "\ascz_thirsk_fix\ThirskW\Data\ui_thirsk_w_ca.paa";
...
class CfgMissions
{
	class Cutscenes
	{
		class ThriskWIntro
		{
			directory = "ascz_thirsk_fix\ThirskW\Scenes\intro.ThirskW";
		};
	};
};