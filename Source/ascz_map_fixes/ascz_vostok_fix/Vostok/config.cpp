class CfgPatches
{
	class ascz_vostok_fix_vostok
	{
		units[] = {"Vostok"};
		worlds[] = {"Vostok"};
		weapons[] = {};
		requiredVersion = 1.0;
		requiredAddons[] = {"Vostok", "AiA_Worlds"};
		author[] = {"EvroMalarkey"};
		version = "1.0";
	};
};
...
class CfgWorlds
{
	...
	class Vostok: Utes
	{
		...
		description = "Vostok";
		pictureMap = "\ascz_vostok_fix\Vostok\Data\Vostok_ca.paa";
		pictureShot = "\ascz_vostok_fix\Vostok\Data\ui_vostok_ca.paa";
...
class CfgMissions
{
	class Cutscenes
	{
		class VostokIntro
		{
			directory = "ascz_vostok_fix\Vostok\Scenes\intro.Vostok";
		};
	};
};