...
class CfgWorlds
{
	...
	class namalsk: Utes
	{
		...
		cutscenes[] = {"intro"};
		description = "Namalsk";
		pictureMap = "\ascz_namalsk_fix\Main\Data\namalsk_ca.paa";
		pictureShot = "\ascz_namalsk_fix\Main\Data\ui_namalsk_ca.paa";
...
class CfgMissions
{
	class Cutscenes
	{
		class intro
		{
			directory = "ascz_namalsk_fix\Main\Scenes\intro.namalsk";
		};
	};
};