...
class CfgVehicles
{
	...
	class C_Driver_2_F: U_C_Driver_2
	{	
		modelsides[] = {3,2,1,0};
	};	
	class C_Driver_1_F: U_C_Driver_1
	{	
		modelsides[] = {3,2,1,0};
	};	
	class C_Driver_3_F: U_C_Driver_3
	{	
		modelsides[] = {3,2,1,0};
	};	
	class C_Driver_4_F: U_C_Driver_4
	{	
		modelsides[] = {3,2,1,0};
	};	
	class C_Marshal_F: U_Marshal
	{	
		modelsides[] = {3,2,1,0};
	};	
	class C_Driver_1_random_base_F: U_Marshal
	{	
		modelsides[] = {3,2,1,0};
	};	
};