class CfgPatches
{
	class Vostok_w
	{
		...
		weapons[] = {};
		requiredVersion = 0.1;
		requiredAddons[] = {"bet_militia","bet_trees"};
	};
};
class CfgWorlds
{
	...
	class Vostok_w: CAWorld
	{
		...
		pictureMap = "\vostok_w_fix\Data\Vostok_w_ca.paa";
		pictureShot = "\vostok_w_fix\Data\ui_vostok_w_ca.paa";
		plateFormat = "ML$ - #####";
		...
		{
			class Vostok_w_Airstrip1
			{
				ilsPosition[] = {16346,4860,5.2};
				ilsDirection[] = {-1,0.08,0};
				ilsTaxiIn[] = {};
				ilsTaxiOff[] = {};
				drawTaxiway = 0;
			};
			class Vostok_w_Airstrip2
			{
		...
		noDetailDist = 40;
		fullDetailDist = 15;
		midDetailTexture = "OLDBR\Vostok_w\data\vos_middle_mco.paa";
		minTreesInForestSquare = 3;
		minRocksInRockSquare = 3;
		class clutter
		{
			class vosw_GrassAutumnBrown: DefaultClutter
			{
			...
			class vosw_GrassCrooked: DefaultClutter
			{
			...
			class vosw_AutumnFlowers: DefaultClutter
			{
			...
			class vosw_GrassTall: DefaultClutter
			{
			...
			class vosw_WeedDead: DefaultClutter
			{
			...
			class vosw_WeedDeadSmall: DefaultClutter
			{
			...
			class vosw_HeatherBrush: DefaultClutter
			{
			...
			class vosw_WeedSedge: DefaultClutter
			{
			...
			class vosw_BlueBerry: DefaultClutter
			{
			...
			class vosw_Deadgrassbunch: DefaultClutter
			{
			...
			class vosw_Grassdrylongbunch: DefaultClutter
			{
...
class CfgMissions
{
	class Cutscenes
	{
		class VostokWIntro
		{
			directory = "vostok_w_fix\Scenes\intro.Vostok_w";
		};
	};
};
class CfgSurfaces
{
	...
	class vos_travaw: Default
	{
		...
		dust = 0.01;
		soundEnviron = "grass";
		character = "vosw_grassClutter";
		soundHit = "soft_ground";
	};
	class vos_skalaw: Default
	{
		access = 2;
		files = "vos_skalaw_*";
		rough = 0.1;
	...
	class vos_snow: Default
	{
		...
		dust = 0.09;
		soundEnviron = "gravel";
		character = "vosw_HillClutter";
		soundHit = "soft_ground";
	};
	class vos_snow2: Default
	{
		access = 2;
		files = "vos_snow2_*";
		rough = 0.1;
		dust = 0.09;
		soundEnviron = "gravel";
		character = "vosw_SnowgrassClutter";
		soundHit = "soft_ground";
	};
};
class CfgSurfaceCharacters
{
	class vosw_grassClutter
	{
		probability[] = {0.1,0.8};
		names[] = {"vosw_GrassAutumnBrown","vosw_GrassCrooked"};
	};
	class vosw_HillClutter
	{
		probability[] = {0.005,0.01};
		names[] = {"vosw_Grassdrylongbunch","vosw_GrassAutumnBrown"};
	};
	class vosw_SnowgrassClutter
	{
		probability[] = {0.1,0.5,0.01};
		names[] = {"vosw_Grassdrylongbunch","vosw_Deadgrassbunch","vosw_HeatherBrush"};
	};
};